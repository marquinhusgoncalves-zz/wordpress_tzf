...
<div class="container">
	<div class="banner-cursos">
		<div class="img-and-text">
			<img src="<?php bloginfo('stylesheet_directory');?>/img/icon-curso-gestao_qualidade.svg" alt="Ícone Cursos TZF Consultoria">
			<p>Atualidades na gestão de<br>qualidade em laboratórios</p>
		</div>
	</div>
